...
export default function SelectField({ label, icon, value, onChange, options = [], accent = "text-[#079D49]" }) {
  return (
    <div className="relative flex h-[66px] items-center rounded-2xl border border-[#dcdcdc] bg-white px-5">
      ...
      <select
        ...
        className="mt-4 w-full bg-transparent pl-3 text-[16px] font-semibold text-[#111] outline-none"
      >
        {options.map((o) => (
